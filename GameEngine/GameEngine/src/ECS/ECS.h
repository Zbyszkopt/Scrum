...
template <typename T> inline ComponentID getComponentTypeID() noexcept		//ta funkcja zwróci cyferke odpowiadaj¹cej T klasie szablonu
{
...
class Component			//klasa abstrakcyjna Component - wszystki komponenty bêd¹ po niej dziedziczyæ
{
public:
	Entity *entity;
